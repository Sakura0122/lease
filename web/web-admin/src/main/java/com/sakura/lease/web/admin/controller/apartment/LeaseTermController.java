...
import com.sakura.lease.model.entity.LeaseTerm;
import com.sakura.lease.web.admin.service.LeaseTermService;
...
public class LeaseTermController {
    ...
    public Result deleteLeaseTermById(@RequestParam String id) {
